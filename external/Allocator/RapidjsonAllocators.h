...
#ifndef __RAPIDJSON_ALLOCATORS_H__
#define __RAPIDJSON_ALLOCATORS_H__
...
public:
    ...
    */
    ...
    {
        assert(size >= SIZEOF_SHARED_DATA + SIZEOF_CHUNK_HEADER);
        shared_->chunkHead = GetChunkHead(shared_);
...
{
    assert(old_n <= SIZE_MAX / sizeof(T) && new_n <= SIZE_MAX / sizeof(T));
...
public:
    ...
    {
        como::Free<U>(baseAllocator_, p, n);
    }
...
#endif // __RAPIDJSON_ALLOCATORS_H__
