...
#if (!defined(tagMEM_AREA_INFO) && !defined(MEM_AREA_INFO))
typedef struct tagMEM_AREA_INFO {
...
void jemallocControl(MEM_AREA_INFO& MemAreaInfo, COMO_CALLOC funComoCalloc);
